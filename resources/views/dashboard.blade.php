          ...
          <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg -mt-64">
                ...
                <div class="mx-auto max-w-3xl px-6 py-12">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16">
                        <div class="bg-white rounded-lg shadow-md p-6">
                            <h2 class="text-xl font-bold text-purple-900 mb-4">Température</h2>
                            <strong>18° C</strong>
                        ...
                        <div class="bg-white rounded-lg shadow-md p-6">
                            <h2 class="text-xl font-bold text-purple-900 mb-4">Lumière</h2>
                            <strong>25</strong>
                        ...
                        <div class="bg-white rounded-lg shadow-md p-6">
                            <h2 class="text-xl font-bold text-purple-900 mb-4">Humidité</h2>
                        ...
                        <div class="bg-white rounded-lg shadow-md p-6">
                            <h2 class="text-xl font-bold text-purple-900 mb-4">Température (relatif a l'humidité)</h2>
                            <strong>16° C</strong>
            ...
            <div class="min-h-screen bg-gradient-to-br from-purple-900 via-indigo-900 to-blue-900">
                <div class="mx-auto max-w-3xl px-6 py-12">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16">
                        <div class="bg-white rounded-lg shadow-md p-6">
                            <h2 class="text-xl font-bold text-purple-900 mb-4">État des lumières</h2>
                            <strong>Allumé / Éteinte</strong> 
                          </div>
                        <div class="bg-white rounded-lg shadow-md p-6">
                            <h2 class="text-xl font-bold text-purple-900 mb-4">État de la pompe</h2>
                            <strong>Allumé / Éteinte</strong>
                           
                          </div>
                        <div class="bg-white rounded-lg shadow-md p-6">
                            <h2 class="text-xl font-bold text-purple-900 mb-4">Niveau de l'eau</h2>
